...
[
  ...
  namespaces.set(item, xlinkNS)
});
[
  'xml:base', 'xml:lang', 'xml:space'
].forEach(function (item) {
  namespaces.set(item, xmlNS)
})
...
[
  ...
  isUnitlessNumber.add(item)
})
var skipProps = new Set();
[
  'children', 'childrenType', 'defaultValue',
  'ref', 'key', 'checked', 'multiple'
].forEach(function (item) {
  skipProps.add(item);
})
...
[
  ...
  'onDrag', 'onDragLeft', 'onDragRight', 'onDragUp', 'onDragUp',
  'onSwipe', 'onSwipeLeft', 'onSwipeRight', 'onSwipeDown', 'onSwipeDown',
].forEach(function (item) {
  delegatedEvents.add(item)
})
