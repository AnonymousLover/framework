<template>
  <v-scroll>
    <v-carousel>
      <ul class="carousel-item row" v-for="order in orders">
    ...
    <p>循环轮播</p>
    <v-carousel-banner :items="items" :click="click" is-loop :slider="slider"/>
    <p>自动循环轮播</p>
    <v-carousel-banner :items="items" :click="click" is-loop :auto="auto"/>
    <p>非循环轮播</p>
